...
public class ParticipantActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dialog(false);
        webView = findViewById(R.id.participants_web);


        webView.loadUrl("https://whizsoftwares.in/IAPSM2023Participants/");
        webView.getSettings().setJavaScriptEnabled(true);
        webView.setWebViewClient(new WebViewClient());

        linearLayoutback_btn = findViewById(R.id.participants_back);
    ...
    public void onBackPressed() {
        Intent intent = new Intent(ParticipantActivity.this, DashBordsActivity.class);
        startActivity(intent);
